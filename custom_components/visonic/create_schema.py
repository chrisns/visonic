...
FormItems: dict[str, list[str]] = {
    ...
    FORM_CLOUD: [CONF_EXTERNAL_URL, CONF_EMAIL, CONF_PASSWORD, CONF_CODE, CONF_PANEL_SERIAL, CONF_SCAN_INTERVAL, CONF_EXCLUDE_SENSOR, CONF_EXCLUDE_SWITCH, CONF_ENABLE_KEYPAD_ALARM_ENTITY],
